...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'images', label: 'Photos', icon: Image, shortcut: 'I' },
  { id: 'background', label: 'Backgrounds', icon: Sparkles, shortcut: 'B' },
  { id: 'drawing', label: 'Draw', icon: Pencil, shortcut: 'D', isNew: true },
  { id: 'charts', label: 'Charts', icon: BarChart3, shortcut: 'C', isNew: true },
  { id: 'table', label: 'Tables', icon: Table, shortcut: 'G', isNew: true },
  { id: 'qr', label: 'QR Code', icon: QrCode, isNew: true },
  { id: 'ai', label: 'AI Tools', icon: Wand2, isAi: true },
...
export const LeftSidebar: React.FC<LeftSidebarProps> = ({
  ...
  return (
    <aside className="w-16 h-full bg-[#0d0e14] border-r border-neutral-800 flex flex-col items-center py-3 z-30 select-none overflow-y-auto scrollbar-none">
      {/* Pointer / Hand Tools */}
      <div className="flex flex-col gap-1 pb-3 mb-3 border-b border-neutral-800 w-full px-2">
        ...
        <button
          ...
          onClick={() => { onSelectTool(activeTool === 'hand' ? 'select' : 'hand'); }}
          className={`w-full aspect-square flex flex-col items-center justify-center rounded-xl transition-all ${
            activeTool === 'hand'
              ? 'bg-violet-600 text-white shadow-lg shadow-violet-600/30'
              : 'text-neutral-400 hover:text-white hover:bg-neutral-800/80'
            ...
            <button
              ...
              className={`w-full aspect-square flex flex-col items-center justify-center rounded-xl transition-all relative ${
                isActive
                  ...
                  : item.isAi
                  ? 'text-violet-400 hover:bg-violet-600/20 hover:text-violet-300'
